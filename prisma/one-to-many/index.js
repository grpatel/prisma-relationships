...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/grishyp/Documents/prisma-relationships/prisma/one-to-many",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "file:./one-to-many/one-to-many.db"
      }
    }
  },
  "inlineSchema": "",
  "inlineSchemaHash": "0a704087a3f6b992e8bcbf7ab3ba6167d903bcb40e1790604560dd8ed3347138"
}
...
path.join(process.cwd(), "prisma/one-to-many/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/one-to-many/schema.prisma")
