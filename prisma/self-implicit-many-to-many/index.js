...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/self-implicit-many-to-many",
    "self-implicit-many-to-many",
  ]
...
path.join(process.cwd(), "prisma/self-implicit-many-to-many/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/self-implicit-many-to-many/schema.prisma")
